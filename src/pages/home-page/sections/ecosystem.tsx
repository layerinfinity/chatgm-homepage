            ...
            >
                ...
                >
                    <Box className={classes.content}>
                        ...
                        <Image mt={15} src='images/one-chainai/svg/gameguru.svg' height={70} fit='contain' />
                        <Text color='#DA99BC' mt={15} ff="Open Sans" fw={400} size={10} ta="center">
                        ...
                        <Text mt={15} fw={700} size={32} color='#9E6B8D33' >
                            Coming soon
                        </Text>
                    </Box>
                </Box> : <></>}
